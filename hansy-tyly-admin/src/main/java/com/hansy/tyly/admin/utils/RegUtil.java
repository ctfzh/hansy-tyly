...
public final class RegUtil {
    ...
    /*汉字*/
    public static final String REG_CHINAESE="[\\u4e00-\\u9fa5]";
    /*英文和数字*/
    public static final String REG_ENGLISH_NUM="^[a-zA-Z][0-9]+$";
    /*数字和小数点*/
    public static final String REG_NUM_POINT="^\\d+(\\.\\d+)?$";

    public static final String REG_NUM_POINT2="^[\\u4E00-\\u9FA5·]+$";

    public static void main(String[] args) {
        String  str="买买提·努尔憨吃";
        boolean matche = isMatche(str, REG_NUM_POINT2);
