...
public class DistributorChange {
    ...
    public DistributorChange(DistributorInfo distributorInfo){
        this.distributorNo = distributorInfo.getDistributorNo();
        this.companyType = distributorInfo.getCompanyType();
        this.distributorAddre = distributorInfo.getDistributorAddre();
        this.distributorContact = distributorInfo.getDistributorContact();
        this.distributorContactPhone = distributorInfo.getDistributorContactPhone();
        this.distributorName = distributorInfo.getDistributorName();
        this.distributorRegNo = distributorInfo.getDistributorRegNo();
        this.distributorStatus = distributorInfo.getDistributorStatus();
        this.legalName = distributorInfo.getLegalName();
        this.staffNo = distributorInfo.getStaffNo();
