...
import com.hansy.tyly.admin.dao.mapper.TUserNewsMapper;
...
public class MessageServiceImpl implements MessageService{
	 ...
	 * 查看消息条数
	 */
	public Integer getNewsCount(Map<String, Object> inMap)throws Exception {

		return tUserNewsMapper.selectNewsCount(inMap);
	}
