...
public class ALiDysmsHelper {
	...
	private BigDataSubmitMapper sysParaMapper;
	...
	public ALiDysmsHelper(BigDataSubmitMapper mapper) {
	...
	public boolean smsSend(String smsTemCode,String phoneNos,Map<String, String> smsValues){
		String accessKeyId  = sysParaMapper.queryParam("aliYunAccessKeyId");
		String accessKeySecret  = sysParaMapper.queryParam("aliYunAccessKeySecret");
		String smsSignName  = sysParaMapper.queryParam("smsSignName");
