...
public class SysRoleController extends BaseController {
    ...
    @ApiOperation(value = "角色列表查询", notes = "{\"roleName\":\"管理员\"}")
    ...
    @ApiOperation(value = "删除角色", notes = "{\"roleId\":\"5e76dba56834459680340ec2c173fa6f\"}")
    ...
    @ApiOperation(value = "更新角色拥有菜单", notes = "{\"menuIds\":\"1\",\"menuUrl\":\"1\"}")
