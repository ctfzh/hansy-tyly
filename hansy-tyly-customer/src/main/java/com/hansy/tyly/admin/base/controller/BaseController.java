...
public class BaseController {
     ...
     * @return
     */
    protected void setCurrentUserProfile(UserProfile userProfile) {
        this.getHttpSession().setAttribute(CURRENT_USER_PROFILE_KEY,userProfile);
    }
     ...
     * @return
     */
    protected String getCurrentUserOrgId() {
        return this.getCurrentUserProfile().getOrgId();
    }
    ...
    protected String getCurrentUserId() {
        return this.getCurrentUserProfile().getUserId();
    }
}
