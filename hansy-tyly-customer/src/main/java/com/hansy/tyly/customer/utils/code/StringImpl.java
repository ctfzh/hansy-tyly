package com.hansy.tyly.customer.utils.code;



import java.io.UnsupportedEncodingException;

import com.hansy.tyly.customer.utils.CharsetUtil;
import com.hansy.tyly.customer.utils.SysUtil;
...
public class StringImpl {
    ...
    private static boolean charReg(char charValue) {
        return (charValue >= 0x4E00 && charValue <= 0X9FA5) || (charValue >= 'a' && charValue <= 'z') || (charValue
                >= 'A' && charValue <= 'Z') || (charValue >= '0' && charValue <= '9');
    }
