...
import com.hansy.tyly.admin.utils.code.BCConvert;
import com.hansy.tyly.customer.utils.code.StringImpl;
...
public final class StringUtil {
    ...
    //金额格式化
    public static String amtFormat(String s, int len) {
        if (s == null || s.length() < 1) {
            return "0.00";
        }else if("0.00".equals(s) || "0.0".equals(s) || "0".equals(s)){
        	return "0.00";
        }
